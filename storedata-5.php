...
$query_Recordset1 = sprintf("SELECT * FROM all_order WHERE Order_sell = %s AND all_order.Order_status = '取消'", GetSQLValueString($colname_Recordset1, "text"));
...
mysql_select_db($database_localhost, $localhost);
$query_Recordset2 = sprintf("SELECT * FROM `user` WHERE user_name = %s", GetSQLValueString($colname_Recordset2, "text"));
