...
$query_commodity = "SELECT * FROM product WHERE product.product_class_contenr = '電腦'";
$commodity = mysql_query($query_commodity, $localhost) or die(mysql_error());
$row_commodity = mysql_fetch_assoc($commodity);
$totalRows_commodity = mysql_num_rows($commodity);mysql_select_db($database_localhost, $localhost);
$query_commodity = "SELECT * FROM product ";
$commodity = mysql_query($query_commodity, $localhost) or die(mysql_error());
$row_commodity = mysql_fetch_assoc($commodity);
